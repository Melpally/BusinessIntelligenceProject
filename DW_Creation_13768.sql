...
DECLARE @CurrentDate DATE = '2016-09-15'
...
---Product Dimension creation script
...
---Seller Dimension creation script
...
---Customer Dimension creation script
...
CREATE TABLE [FactOrder](
	...
	[PaymentValue] float,
	[PurchaseDateKey] int,
	FOREIGN KEY (PurchaseDateKey) REFERENCES Dim_Date(DateKey),
